...
import InfectionTreeGenerator.Graph.GraphAlgorithms.DistanceMeasures.TreeEditDistance.TreeEditDistanceLPCplex;
 ...
 * @author MaxSondag
 */
public class TreeEditDistanceLPCplexTest {

    Tree t1, t2, t3, t4, t5;
    Node n1, n2, n3, n4, n5, n6, n7, n8, n9, n10, n11;
    Edge e12, e13, e45, e56, e78, e910;

    public TreeEditDistanceLPCplexTest() {
    }
    ...
    /**
     * Test of getMapping method, of class TreeEditDistanceLPCplexCplex.
     */
    @Test
    public void testGetMapping() {
        System.out.println("getMapping");
        //solve it to get the mapping
        TreeEditDistanceLPCplex instance = new TreeEditDistanceLPCplex(t1, t2);
        instance.solve();
    ...
    /**
     * Test of solve method, of class TreeEditDistanceLPCplex.
     */
    @Test
    public void testSolve() {
        ...
        //inverse is equal
        instance = new TreeEditDistanceLPCplex(t2, t1);
        ted = instance.solve();
        assertEquals(2, ted);

        //can be 0
        instance = new TreeEditDistanceLPCplex(t3, t4);
        ted = instance.solve();
        assertEquals(0, ted);

        //can be 1
        instance = new TreeEditDistanceLPCplex(t1, t4);
        ted = instance.solve();
        assertEquals(1, ted);

        //can go towards a singleton node
        instance = new TreeEditDistanceLPCplex(t1, t5);
        ted = instance.solve();
        assertEquals(2, ted);

        //and also from a singleton node
        instance = new TreeEditDistanceLPCplex(t5, t1);
        ted = instance.solve();
        assertEquals(2, ted);
