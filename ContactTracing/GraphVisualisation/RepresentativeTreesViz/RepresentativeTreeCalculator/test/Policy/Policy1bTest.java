 ...
 * @author MaxSondag
 */
public class Policy1bTest extends PolicyTest {
    ...
    public void setUp() {
        ...
        addContact(n10, n11, 27, true);//chain from n11
    ...
    public void testAddPolicyData() {
        ...
        Policy1b instance = new Policy1b(g, events, contactsFromUser, randomAppPercentages, 1);
        ...
        assertTrue(n3.policies.contains("1bA100Origin"));

        assertEquals(1, n5.policies.size());
        assertTrue(n5.policies.contains("1bA100"));

        assertEquals(1, n9.policies.size());
        assertTrue(n9.policies.contains("1bA100Origin"));

        assertEquals(1, n10.policies.size());//direct result of alerted node isolating
        assertTrue(n10.policies.contains("1bA100Origin"));

        assertEquals(1, n11.policies.size());//chained to 10
        assertTrue(n11.policies.contains("1bA100"));
    }
    ...
    public void testNoApp() {
        ...
        Policy1b instance = new Policy1b(g, events, contactsFromUser, randomAppPercentages, 0);
        instance.addPolicyData();
        ...
        assertEquals(1, n10.policies.size());//direct result of alerted node isolating
        assertTrue(n10.policies.contains("1bA0Origin"));

        assertEquals(1, n11.policies.size());//chained to n6
        assertTrue(n11.policies.contains("1bA0"));
    }
}
